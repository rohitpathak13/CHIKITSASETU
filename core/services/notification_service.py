...
class NotificationService:
    ...
    def scan_and_generate_operational_notifications(cls, db: Session) -> Dict[str, int]:
        ...
        # 1. Low Stock Scan
        try:
            from core.models.pharmacy import Medicine
        ...
        try:
            from core.models.pharmacy import MedicineInventory, Medicine
        ...
        try:
            from core.models.clinical import Appointment, AppointmentStatusEnum
            from core.models.user import DoctorProfile, PatientProfile
        ...
        try:
            from core.models.billing import Bill, BillStatusEnum
            pending_bills = (
                db.query(Bill)
