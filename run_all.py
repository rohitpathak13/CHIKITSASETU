...
def print_banner():
    ...
    print("-" * 65)
    print("  ► [DEV DEMO ONLY] Admin Login:   admin@chikitsasetu.ai  /  Password123!")
    print("  ► [DEV DEMO ONLY] Doctor Login:  dr.sharma@chikitsasetu.ai / Password123!")
    print("  ► [DEV DEMO ONLY] Patient Login: patient.john@chikitsasetu.ai / Password123!")
    print("=" * 65)
